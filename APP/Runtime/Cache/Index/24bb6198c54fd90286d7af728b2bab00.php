...
<div class="body_3">
    <div class="query_para">
        <form method="post" action="<?php echo U('Query/original_sent_handle');?>">
            <div class="form-group">
                <label for="original_sent">请输入要查询的例句</label>
                <input type="text" class="form-control" id="original_sent" name="original_sent">
            </div>
